...
pub fn animate_weapon_display(
    time: Res<Time>,
    mut weapons: Query<(&mut Transform, &mut WeaponDisplay, &MeshMaterial3d<StandardMaterial>)>,
...
pub fn hide_weapon_on_shoot(
    mut weapons: Query<(&mut Visibility, &mut WeaponDisplay)>,
) {
